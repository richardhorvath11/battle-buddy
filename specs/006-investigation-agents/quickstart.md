...
| US1/US5 anchoring guard, phase-scoped (SC-004) | `pytest tests/contract/test_anchoring_matrix.py -q` | Both invariant phases × {2 live, 3 live none fresh, 3 live with fresh, dead fresh} classify with the exact rule names; early phases accept sparse/empty ledgers |
