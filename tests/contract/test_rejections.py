...
CORPUS = [
    ...
    ("append_record-non-map-payload", "storage", "append_record",
     "not-a-map", "invalid_input", "payload"),
    ("read_records-typoed-payload-key", "storage", "read_records",
     {"fitler": {"fingerprint": "fp"}}, "invalid_input", "fitler"),
